...
| `ultra` | Bare fragments. Strip conjunctions when cause-effect stays unambiguous. Standard acronyms OK (DB, API); no invented abbreviations (fn, auth, cfg), no arrows (X → Y) — measured zero token saving under tokenizer, costs decode clarity. |
