...
`../../references/security-checklist.md` is this repo's single source of truth
for the security review checklist — authentication, authorization, API security,
input validation, file handling, browser security, data protection, secrets,
dependency/supply-chain, infrastructure, and logging — plus the OWASP Top 10 and
OWASP LLM Top 10 quick-reference tables. Work from it rather than re-deriving a
checklist here.

Read `../../references/ai-security.md` when the change touches an LLM, agent,
